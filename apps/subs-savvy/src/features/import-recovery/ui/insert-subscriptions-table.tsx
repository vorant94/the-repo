...
export const InsertSubscriptionsTable: FC<InsertSubscriptionsTableProps> = ({
  subscriptions,
  ...
  const categories = categoriesFromProps ?? categoriesFromDb;

  const categoriesData: ComboboxData = categories.map((category) => ({
    label: category.name,
    value: `${category.id}`,
  }));
              ...
              <Table.Tr key={field.id}>
                ...
                <Table.Td className={cn("min-w-40")}>
                  <TextInput
                    ...
                    error={errors.subscriptions?.[index]?.description?.message}
                  />
                </Table.Td>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <NumberInput
                        ...
                        onChange={onChange}
                        placeholder={t("price")}
                        error={errors.subscriptions?.[index]?.price?.message}
                      />
                    )}
                  />
                </Table.Td>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <DatePickerInput
                        ...
                        onChange={onChange}
                        onBlur={onBlur}
                        error={errors.subscriptions?.[index]?.endedAt?.message}
                      />
                    )}
                  />
                </Table.Td>
                  ...
                  <Controller
                    ...
                    render={({ field: { onChange, onBlur, value } }) => (
                      <NumberInput
                        ...
                        placeholder={t("each")}
                        error={
                          errors.subscriptions?.[index]?.cycle?.each?.message
                        }
                      />
                    )}
                  />
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange, onBlur } }) => (
                      <Select
                        ...
                        error={
                          errors.subscriptions?.[index]?.cycle?.period?.message
                        }
                      />
                    )}
                  />
                  ...
                  <Controller
                    ...
                    render={({ field: { value, onChange, onBlur } }) => (
                      <Select
                        ...
                        onBlur={onBlur}
                        error={errors.subscriptions?.[index]?.category?.message}
                      />
                    )}
                  />
                </Table.Td>
